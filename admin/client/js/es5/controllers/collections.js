    ...
    (function (controllers) {
        ...
        (function (collections) {
            ...
            hibachi.getModule()
                ...
                function ($scope, $location, $log, $timeout, $slatwall, collectionService, metadataService, selectionService, paginationService, collectionConfigService) {
                    //init values 
                    ...
                    $scope.getCollection = function () {
                        ...
                        collectionListingPromise.then(function (value) {
                            ...
                            if (angular.isUndefined($scope.collectionConfig)) {
                                var test = collectionConfigService.newCollectionConfig($scope.collection.collectionObject);
